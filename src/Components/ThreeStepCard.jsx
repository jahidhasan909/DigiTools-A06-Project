...
const ThreeStepCard = () => {
    return (
        <div className='bg-base-300 mt-32'>
            <div className='px-10 py-10 md:px-50 md:py-28'>
                <h1 className='text-center mt font-bold text-2xl md:text-4xl'>Get Started in 3 Steps</h1>
                <p className='text-center mt-4 text-gray-400 text-[0.74rem] md:text-[0.85rem]'>Start using premium digital tools in minutes, not hours.</p>
