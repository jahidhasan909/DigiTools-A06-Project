            ...
            <div className="hero min-h-screen container mx-auto">
                <div className="hero-content flex-col lg:flex-row-reverse ">
                    <img
                        ...
                        className="max-w-2xs md:max-w-110 max-h-md rounded-lg shadow-2xl"
                    />
                    <div className='md:mr-50'>
                        <div className="badge badge-soft badge-primary mb-3">
                            <FaRegDotCircle />
                            New: AI-Powered Tools Available</div>
                        <h1 className="text-2xl md:text-6xl  md:leading-20    font-bold">Supercharge Your <br /> Digital Workflow</h1>
                        <p className="py-6 text-[0.70rem] md:text-[1.10rem] text-neutral/50">
